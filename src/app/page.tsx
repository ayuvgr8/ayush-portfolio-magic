...
export default function Page() {
  ...
  useEffect(() => {
    if (isSkillsInView && confettiRef.current) {
  ...
  return (
    <main className="flex flex-col min-h-[100dvh] space-y-10 relative overflow-hidden">
      ...
      <section id="skills" ref={skillsRef} className="relative overflow-hidden">
        <Confetti
          ref={confettiRef}
          className="absolute left-0 top-0 z-0 size-full"
          manualstart={true}
        />
        <div className="relative z-10 flex min-h-0 flex-col gap-y-3">
          <BlurFade delay={BLUR_FADE_DELAY * 9}>
            <h2 className="text-xl font-bold">Skills</h2>
          </BlurFade>
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 max-w-[800px] mx-auto">
            {DATA.skills.map((skill, id) => (
              <BlurFade key={skill.category} delay={BLUR_FADE_DELAY * 10 + id * 0.05}>
                  ...
                  <CardContent>
                    <div className="flex flex-wrap gap-1">
                      {skill.skills.map((item) => (
                        <Badge key={item.name} variant="secondary" className="text-xs flex items-center gap-2 px-2 py-1">
